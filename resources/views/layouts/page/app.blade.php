...
{{--    </script>--}}
{{--    <noscript><a href="https://www.livechat.com/chat-with/19414804/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>--}}
...
{{--                        <p class="m-0 text-g-yellow"><i data-feather="chevron-right" class="text-white" stroke-width="1"></i> 110911</p>--}}
                ...
                <div class="row">
                    <div class="col text-center">
                        <small class="text-white">Grupo GOTOPERU 2022. Todos los derechos reservados.</small>
                    </div>
                </div>
            </div>
        </div>
