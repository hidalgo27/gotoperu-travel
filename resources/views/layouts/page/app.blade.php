...
{{--                                </li>--}}
                                <li class="item">
                                    ...
                                    <div class="social-info">
                                        <a href="tel:51980565849">+51 980 565 849</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row justify-content-end">
                <div class="col-auto">
                    <div class="bg-dark rounded px-3 mx-3 shadow clearfix float-right">
                        <a href="https://api.whatsapp.com/send?phone=51980565849" target="_blank" class="font-weight-bold text-white stretched-link">
